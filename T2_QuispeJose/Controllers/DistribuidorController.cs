...
namespace T2_QuispeJose.Controllers
{
    public class DistribuidorController : Controller
    {
        ...
        {
            IEnumerable<Distribuidor> lista = _db.Distribuidores;
            return View(lista);
        }
        public IActionResult DistribuidoresPeruanos()
        {
            return View();
        }
        ...
        public IActionResult Editar(int? Id)
        {
            ...
            var obj = _db.Distribuidores.Find(Id);
            if (obj==null)
            {
                return NotFound();
            }
        ...
        public IActionResult Editar(Distribuidor distribuidor)
        {
            if (ModelState.IsValid)
            {
                _db.Distribuidores.Update(distribuidor);
                _db.SaveChanges();
                return RedirectToAction(nameof(Index));
            }
            return View(distribuidor);
